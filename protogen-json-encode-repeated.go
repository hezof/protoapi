...
func EncodeMessageRepeated[Message any](w *JsonEncoder, value []*Message, f func(w *JsonEncoder, m *Message)) {
	switch {
	case value == nil:
		w.ensure(4)
		w.buff = append(w.buff, 'n', 'u', 'l', 'l')
...
func EncodeMessageRepeated_OmitEmpty[Message any](w *JsonEncoder, name string, value []*Message, f func(w *JsonEncoder, m *Message)) {
	if len(value) != 0 {
		w.ensure(4 + len(name))
		w.buff = append(w.buff, quotes)
		w.buff = append(w.buff, name...)
...
func EncodeMessageRepeated_WithEmpty[Message any](w *JsonEncoder, name string, value []*Message, f func(w *JsonEncoder, m *Message)) {
	switch {
	case value == nil:
		w.ensure(8 + len(name))
		w.buff = append(w.buff, quotes)
...
func EncodeMessageRepeated_ConvEmpty[Message any](w *JsonEncoder, name string, value []*Message, f func(w *JsonEncoder, m *Message)) {
	switch {
	case value == nil || len(value) == 0:
		w.ensure(6 + len(name))
		w.buff = append(w.buff, quotes)
