...
func TestHttpSimple(t *testing.T) {
	rsp := new(api.Book)
	err := cli.POST("/simple/book", book, clients.NormalResult(rsp), 200)
	if err != nil {
		t.Fatal(err)
	}
...
func TestHttpClient(t *testing.T) {
	rsp := new(api.Book)
	err := cli.POST("/client/book", book, clients.UnwrapResult(rsp), 200)
	if err != nil {
		t.Fatal(err)
	}
	fmt.Println(core.ToJson(rsp))
...
func TestHttpServer(t *testing.T) {
	rsp := new(api.Book)
	err := cli.POST("/server/book", book, clients.UnwrapResult(rsp), 200)
	if err != nil {
		t.Fatal(err)
	}
	fmt.Println(core.ToJson(rsp))
...
func TestHttpDirectional(t *testing.T) {
	rsp := new(api.Book)
	err := cli.POST("/bidirectional/book", book, clients.UnwrapResult(rsp), 200)
	if err != nil {
		t.Fatal(err)
	}
	fmt.Println(core.ToJson(rsp))
